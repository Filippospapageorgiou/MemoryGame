...
<div class="flex justify-center items-center min-h-screen bg-gradient-to-br from-orange-500 to-pink-600">
  <div class="bg-white p-8 rounded-lg shadow-lg">
    ...
    <form class="w-full max-w-md" on:submit|preventDefault={confirmusername}>
      <div class="mb-4">
        <input
          type="text"
          placeholder="Username"
          class="input w-full border-2 rounded p-2 focus:outline-none focus:border-orange-500"
          bind:value={username}
      ...
      <div class="my-4">
        ...
        {#if !isTaken && isValid && !loading}
          ...
          type="submit"
          value="Register"
          class="w-full p-2 rounded bg-gradient-to-br from-orange-500 to-pink-600 text-white cursor-pointer hover:opacity-90"
         />
        {/if}
      </div>
    </form>
